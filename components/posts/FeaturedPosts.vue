<template>
  <div>
    <section class="flex flex-wrap gap-10 sm:justify-center md:justify-start md:px-8">
      <article v-for="(post, i) in posts" :key="i" class="Post basis-full sm:basis-[500px] md:basis-[47%]">
